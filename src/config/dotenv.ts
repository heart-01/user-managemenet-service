...
export const USERNAME_CHANGE_LIMIT_DAYS = process.env.USERNAME_CHANGE_LIMIT_DAYS || 7;
...
export const SENDGRID_TEMPLATE_DELETE_ACCOUNT_EMAIL =
  process.env.SENDGRID_TEMPLATE_DELETE_ACCOUNT_EMAIL || '';
export const SENDGRID_TEMPLATE_DELETE_ACCOUNT_SUCCESS_EMAIL =
  process.env.SENDGRID_TEMPLATE_DELETE_ACCOUNT_SUCCESS_EMAIL || '';
export const SENDGRID_TEMPLATE_RESTORE_ACCOUNT_SUCCESS_EMAIL =
  process.env.SENDGRID_TEMPLATE_RESTORE_ACCOUNT_SUCCESS_EMAIL || '';
